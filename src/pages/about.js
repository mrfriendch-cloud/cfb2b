    ...
    <section class="container" style="margin-top: 3rem;">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: center;">
        <div>
          ...
          <p style="color: var(--text-light); line-height: 1.8; margin-bottom: 1rem;">
            Our official website offers full-range high-quality knitted wholesale, including men's, women's, children's wear and home knitted products.
          </p>
          <p style="color: var(--text-light); line-height: 1.8;">
            We provide compliant quality, affordable prices, stable supply, bulk customization and efficient distribution to help local distributors and retailers reduce costs and seize market opportunities.
          </p>
        </div>
        <div>
